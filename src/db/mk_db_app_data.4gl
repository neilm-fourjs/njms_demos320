...
FUNCTION insStock(
	...
	LET l_col = 0
	IF DOWNSHIFT(l_ds) MATCHES "*red*" THEN
		LET l_col = get_colour("Red")
	END IF
	IF DOWNSHIFT(l_ds) MATCHES ("*blue*") THEN
		LET l_col = get_colour("Blue")
	END IF
	IF DOWNSHIFT(l_ds) MATCHES ("*black*") THEN
		LET l_col = get_colour("Black")
	END IF
	IF DOWNSHIFT(l_ds) MATCHES ("*green*") THEN
		LET l_col = get_colour("Green")
	END IF
	IF DOWNSHIFT(l_ds) MATCHES ("*yellow*") THEN
		LET l_col = get_colour("Yellow")
	END IF
	IF DOWNSHIFT(l_ds) MATCHES ("*purple*") THEN
		LET l_col = get_colour("Purple")
	END IF
