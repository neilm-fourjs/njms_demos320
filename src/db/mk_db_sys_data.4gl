...
FUNCTION insert_system_data()
  ...
  CALL addMenu("demo", "main", "F", "Stock Demo - GBC / UR Only!", "stackDemo.42r", "")
  ...
  CALL addMenu("wcdemo", "demo", "F", "D3Charts", "wc_d3charts_demo.42r", "")
  CALL addMenu("wcdemo", "demo", "F", "Gauge", "wc_gauge.42r", "")
  ...
  CALL addMenu("oeprn", "oe", "F", "Print Invoices ASK", "printInvoices.42r 0 ordent ASK preview", "")
  CALL addMenu("oeprn", "oe", "F", "Print Invoices PDF", "printInvoices.42r 0 ordent PDF preview", "")
