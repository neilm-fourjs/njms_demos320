...
FUNCTION insert_system_data()
	...
	CALL addMenu("demo", "main", "F", "Widgets Demo", "widgets.42m", "")
	CALL addMenu("demo", "main", "F", "ipodTree Demo", "ipodTree.42m", "")
--	CALL addMenu("demo", "main", "F", "picFlow Demo", "picFlow.42m", "")
	CALL addMenu("demo", "main", "F", "Display Array Demo 1", "dispArr.42m A", "")
	CALL addMenu("demo", "main", "F", "Display Array Demo 2", "dispArr.42m B", "")
	CALL addMenu("demo", "main", "F", "Input Array Expenses Demo", "expenses.42m", "")
	CALL addMenu("demo", "main", "F", "Multi Cell Select", "multi_cell_sel.42m", "")
	CALL addMenu("demo", "main", "F", "Simple Table", "table.42m", "")
	CALL addMenu("demo", "main", "F", "Table - List View - GBC / AwesomeUR Only", "listView.42m", "")
	CALL addMenu("demo", "main", "F", "Stack Demo - GBC / UR Only!", "stackDemo.42m", "")

	CALL addMenu("wizard", "demo", "T", "Wizard - Dialog Demos", "", "")
	CALL addMenu("wizard", "demo", "F", "Wizard SD", "wizard_sd.42m", "")
	CALL addMenu("wizard", "demo", "F", "Wizard MD", "wizard_md.42m", "")
	CALL addMenu("wizard", "demo", "F", "Wizard MRS", "wizard_mrs.42m", "")
	CALL addMenu("wizard", "demo", "F", "Wizard DnD", "wizard_dnd.42m", "")
...
FUNCTION mk_demo_account()
	...
	LET l_user.pass_hash =
			g2_secure.g2_genPasswordHash(C_DEF_USER_PASSWD, l_user.salt, l_user.hash_type)
	...
	TRY
		...
		CALL mkdb_progress(
				SFMT("Test Account Inserted: %1 / %2 with %3 hash.",
						C_DEF_USER_EMAIL, C_DEF_USER_PASSWD, l_user.hash_type))
	CATCH
	...
	FOR x = 1 TO l_juser.getLength()
		...
		LET l_user.email =
				DOWNSHIFT(l_user.forenames[1] || "." || l_user.surname CLIPPED || "@njmdemos.com")
		DISPLAY "User:",
				l_user.salutation,
				" ",
				l_user.forenames,
