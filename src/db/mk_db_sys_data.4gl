...
FUNCTION insert_system_data(l_db STRING)
	...
	CALL addMenu("wcdemo", "demo", "F", "GoogleMaps", "wc_gm", "")
	...
	CALL addMenu("mnt", "main", "F", "Stock Cat Maintenance", "dynMaint " || l_db || " stock_cat cat_code", "")
	...
	CALL addMenu("oe", "main", "F", "Order Entry", "ordent ", "")
	...
	CALL addMenu("util", "main", "P", "Font Viewer: FontAwesome Default", "../utils/fontAwesome.sh def", "")
	CALL addMenu("util", "main", "P", "Font Viewer: FontAwesome v5", "../utils/fontAwesome.sh fa5", "")
	CALL addMenu("util", "main", "P", "Font Viewer: FontAwesome v6.5", "../utils/fontAwesome.sh fa6", "")
	CALL addMenu("util", "main", "P", "Font Viewer: njmdemos_i2f", "../utils/fontAwesome.sh njm", "")
