  ...
  DIALOG ATTRIBUTE(UNBUFFERED)
    ...
    ON ACTION about
      CALL g2_about.g2_about(l_appInfo)
		ON ACTION actiona ERROR "Control-A"
		ON ACTION actionb ERROR "Control-B"
		ON ACTION actionc ERROR "Control-C"
		ON ACTION actiond ERROR "Control-D"
		ON ACTION actione ERROR "Control-E"
		ON ACTION actionf ERROR "Control-F"
		ON ACTION actiong ERROR "Control-G"
		ON ACTION actionh ERROR "Control-H"
		ON ACTION actioni ERROR "Control-I"
		ON ACTION actionj ERROR "Control-J"
		ON ACTION actionk ERROR "Control-K"
		ON ACTION actionl ERROR "Control-L"
		ON ACTION actionm ERROR "Control-M"
		ON ACTION actionn ERROR "Control-N"
		ON ACTION actiono ERROR "Control-O"
		ON ACTION actionp ERROR "Control-P"
		ON ACTION actionq ERROR "Control-Q"
		ON ACTION actionr ERROR "Control-R"
		ON ACTION actions ERROR "Control-S"
		ON ACTION actiont ERROR "Control-T"
		ON ACTION actionu ERROR "Control-U"
		ON ACTION actionv ERROR "Control-V"
		ON ACTION actionw ERROR "Control-W"
		ON ACTION actionx ERROR "Control-X"
		ON ACTION actiony ERROR "Control-Y"
		ON ACTION actionz ERROR "Control-Z"
		ON ACTION f1 ERROR "F1"
		ON ACTION f2 ERROR "F2"
		ON ACTION f3 ERROR "F3"
		ON ACTION f4 ERROR "F4"
		ON ACTION f5 ERROR "F5"
		ON ACTION f6 ERROR "F6"
		ON ACTION f7 ERROR "F7"
		ON ACTION f8 ERROR "F8"
		ON ACTION f9 ERROR "F9"
		ON ACTION f10 ERROR "F10"
		ON ACTION f11 ERROR "F11"
		ON ACTION f12 ERROR "F12"
    ON ACTION close
      EXIT DIALOG
    ON ACTION quit
      EXIT DIALOG
